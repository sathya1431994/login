  ...
  <div class="modal-dialog" align="center">
    ...
    <div class="modal-content">
      ...
      <form action="register" method="GET">
       username <input type="text" place holder="username..." name="reg_uname"></br></br>
       password <input type="text" place holder="password..." name="reg_pass"></br></br>
       Email <input type="text" place holder="Email..." name="reg_email"></br></br>
